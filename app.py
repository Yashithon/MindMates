...
with col2:
    ...
    <div class="info-card">
        ...
        <ul>
            ...
            <li>Offers AI-generated understanding, not medical diagnosis</li>
    ...
    <div class="info-card">
        ...
        <ul>
            ...
            <li>This tool complements professional support</li>
...
<div class="footer">
    ...
    <p class="footer-disclaimer">
        This tool is designed for educational and supportive purposes. For professional medical advice, diagnosis, or treatment, please consult qualified healthcare providers.
    </p>
</div>
""", unsafe_allow_html=True)
